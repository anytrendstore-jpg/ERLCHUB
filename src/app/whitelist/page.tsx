        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            <div className="space-y-6 order-2 lg:order-1">
              <h2 className="text-2xl font-bold text-white">¿Por qué hacer whitelist?</h2>

              <div className="grid gap-4">
                {features.map((feature) => (
                  <div
                    key={feature.title}
                    className="flex items-start gap-4 p-4 bg-[#12121c]/60 border border-[#1a1a28] rounded-xl hover:border-[#8e00f7]/30 transition-colors"
                  >
              ...
              <div className="grid grid-cols-3 gap-4 pt-4">
                <div className="text-center">
                  ...
                  <div className="text-gray-500 text-xs">Jugadores Activos</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-[#22c55e]">98%</div>
                  <div className="text-gray-500 text-xs">Aprobación</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-white">24h</div>
                  <div className="text-gray-500 text-xs">Revisión Máx.</div>
                </div>
              </div>
            </div>
            ...
            <div className="order-1 lg:order-2 animate-modal-card">
              <WhitelistCard>
                <div className="p-8 text-center border-b border-[#1e1e2e]">
                  ...
                  <h2 className="text-xl font-bold text-white">Accede con Discord</h2>
                ...
                <div className="p-6 space-y-4">
                  ...
                  {devLoginAllowed && (
                    <form onSubmit={handleDevLogin} className="pt-4 border-t border-[#1e1e2e] space-y-3">
                      ...
                      <button
                        type="submit"
                        disabled={isLoading}
                        className="w-full h-11 bg-[#1a1a28] hover:bg-[#2a2a3a] disabled:opacity-50 text-white text-sm font-semibold rounded-xl transition-colors"
                      >
