...
function LoginPageContent() {
    ...
    return (
      <div className="min-h-screen bg-[#0a0a12] flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-400 text-sm">Serás redirigido a la página de inicio en unos segundos...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen bg-[#0a0a12] flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-400 mt-4">Verificando sesión...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="min-h-screen bg-[#0a0a12] flex items-center justify-center">
        <div className="text-center max-w-md mx-auto p-6">
          <div className="mb-6">
            ...
            <h2 className="text-2xl font-bold text-white mb-2">Ya tienes sesión activa</h2>
            <p className="text-gray-400 mb-6">Estás conectado a tu cuenta de Discord</p>
          </div>
          ...
          <div className="space-y-3">
            ...
            <Link
              href="/"
              className="w-full h-12 flex items-center justify-center gap-3 bg-transparent border border-[#1e1e2e] hover:border-[#2a2a3a] text-gray-400 hover:text-white font-semibold rounded-xl transition-all"
            >
              Explorar el sitio
            </Link>
          </div>
  ...
  return (
    <div className="min-h-screen bg-[#0a0a12] flex items-center justify-center px-4 py-12 relative overflow-hidden">
      <ParticlesBackground />
      <div className="relative z-10 w-full max-w-[400px]">
        <div className="bg-[#12121c] border border-[#1e1e2e] rounded-2xl p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400 text-sm">Para iniciar sesión, regresa a la página principal</p>
          </div>
          
          <div className="space-y-4">
            <div className="bg-[#1a1a28] border border-[#2a2a3a] rounded-xl p-4">
              <div className="flex items-center gap-3 text-gray-300">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500">Allí encontrarás el botón "Iniciar con Discord"</p>
                </div>
              </div>
            </div>
...
export default function LoginPage() {
  return (
    <Suspense fallback={<div className="min-h-screen bg-[#0a0a12] flex items-center justify-center"><div className="text-white">Cargando...</div></div>}>
      <LoginPageContent />
    </Suspense>
  );
}