...
export default function ReviewsPage() {
  ...
  if (loading && (!reviews || reviews.length === 0)) {
    return (
      <div className="min-h-screen bg-[#0c0c14] pt-20">
        <Navbar />
    ...
    <div className="min-h-screen bg-[#0c0c14] pt-20">
      ...
      <div className="container mx-auto px-4 py-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6 max-w-5xl mx-auto">
          <div className="bg-[#12121c] border border-[#1a1a28] rounded-xl p-4 text-center">
          ...
          <div className="bg-[#12121c] border border-[#1a1a28] rounded-xl p-4 text-center">
            ...
            <div className="text-gray-400 text-xs mb-1">Comunidad</div>
          ...
          <div className="bg-[#12121c] border border-[#1a1a28] rounded-xl p-4 text-center">
            ...
            <div className="text-gray-400 text-xs mb-1">Tienda</div>
          ...
          <div className="bg-[#12121c] border border-[#1a1a28] rounded-xl p-4 text-center">
            ...
            <div className="text-gray-400 text-xs mb-1">Hub Coins</div>
            <div className="flex justify-center"><Stars rating={Math.round(stats?.hubCoins?.avgRating || 0)} size="w-3.5 h-3.5" /></div>
          </div>
        </div>

        <div className="flex justify-center mb-8">
          <div className="bg-[#12121c] border border-[#1a1a28] rounded-xl p-1 inline-flex flex-wrap justify-center">
            ...
            {reviews.map((review: any) => {
              ...
              return (
                <div
                  ...
                  className="group bg-[#12121c] border border-[#1a1a28] rounded-xl p-6 transition-all duration-300 hover:-translate-y-1 hover:border-[color:color-mix(in_srgb,var(--tag-color)_45%,transparent)] hover:shadow-[0_20px_45px_-25px_var(--tag-color)]"
        ...
        {(!reviews || reviews.length === 0) && !loading && !error && (
          <div className="text-center py-16">
            ...
            <p className="text-gray-300 text-lg font-medium mb-1">Todavía no hay reseñas acá</p>
      ...
      {showReviewForm && (
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-[#12121c] border border-[#1a1a28] rounded-2xl p-6 max-w-md w-full">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  {(['Comunidad', 'Tienda', 'Hub Coins'] as const).map((t) => (
                    <button
                      ...
                      className={`px-2 py-2 rounded-lg text-xs font-bold transition-all ${
                        formData.tag === t ? 'bg-[#8e00f7] text-white' : 'bg-[#1a1a28] text-gray-400'
                      }`}
                    >
                      {t}
                    </button>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3 bg-[#0c0c14] border border-[#1a1a28] rounded-xl text-white text-sm h-32 resize-none focus:border-[#8e00f7] outline-none"
              ...
              <div className="flex gap-3">
                <button
                  ...
                  className="flex-1 px-4 py-3 bg-[#1a1a28] text-white rounded-xl text-sm"
                >
                  Cancelar
                </button>
                <button
